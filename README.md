...
> If a model stays idle for a while, it may be automatically unloaded/stopped (depending on the runtime policy) to save resources.\
...
- Message your bot `/pair` to get a pairing code
- Run in CLI: `openclaw pairing approve {channel} {code}`
